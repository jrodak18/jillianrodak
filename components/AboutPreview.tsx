    ...
    <section className="py-24 bg-white">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-xl text-gray-700 leading-relaxed mb-6 font-light">
          My name is Jillian Rodak, and I have 16 years of experience navigating pivotal career moments. I can help you rise to the occasion throughout yours.
        </p>
        <p className="text-gray-500 leading-relaxed mb-10">
          My mission is to empower you to feel confident and equipped to steer your career path. I help my clients make incredible progress in their careers by upgrading their personal and professional strategies, tools, and practices to make major differences with long-term impact.
        </p>
        <a 
          href="#story" 
