  ...
  return (
    <section id="story" className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-gray-600 font-light leading-relaxed mb-12">
          <img
            src="/jillian-about.png"
            alt="Jillian Rodak"
            className="w-full md:w-1/3 h-auto rounded-lg shadow-lg float-none md:float-left md:mr-8 mb-6"
          />
          <p className="mb-6">
          ...
          <div className="bg-neutral-50 p-6 md:p-8 rounded-lg my-8 border-l-4 border-secondary clear-both">
